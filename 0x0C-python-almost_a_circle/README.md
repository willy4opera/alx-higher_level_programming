...
# Project Author: Odionye Obiajul Williams
# Project Start Date: 15/09/2023
# Project End Date: 19/09/2023
 
### NOTE: FOR TEST 0 TO CHECK, YOU HAVE TO TEST FILES USING THE COMMAND `python3 -m unittest tests/test_models/test_base.py`

During the course of this project, I developed skills in Python object-oriented programming; by writting codes for three connected classes to represent rectangles and squares. I was able to write my own test suite using the `unittest` module to test all functionality for each class.
